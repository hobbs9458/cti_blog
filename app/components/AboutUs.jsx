  ...
  return (
    <div className={styles.aboutUsWrap}>
      ...
      <p className={styles.aboutUsP}>
        We are more than just a tool distribution company. We are an engineering
        driven, machine solutions provider. We solve our customers' problems at
        the spindle, saving time and money while making our customers more
        efficient and profitable.
      </p>
      <p className={styles.aboutUsP}>
        Our sales team is comprised of degreed engineers and those with decades
        of experience in the manufacturing industry, and we know that sets us
        apart.
      </p>
      ...
      <p className={styles.aboutUsP}>
        ...
        increases in overall productivity. Our technical tooling competency has
        helped customers double and even triple their productivity.
      </p>
      <Image
